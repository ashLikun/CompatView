package com.ashlikun.compatview.simple.spannableutils;
...
import com.ashlikun.compatview.simple.AppUtils;
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(AppUtils.getApp(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(AppUtils.getApp(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(AppUtils.getApp(), resourceId), start, end, flag);
                    resourceId = 0;
