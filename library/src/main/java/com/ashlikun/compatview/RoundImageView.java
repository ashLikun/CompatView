...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        type = a.getInt(R.styleable.RoundImageView_riv_type, TYPE_ROUND);
        mBorderColor = a.getColor(R.styleable.RoundImageView_riv_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.RoundImageView_riv_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.RoundImageView_riv_corner_radius, dp2px(10));
        mLeftTopCornerRadius = a.getDimension(R.styleable.RoundImageView_riv_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.RoundImageView_riv_leftBottom_corner_radius, 0);
        mRightTopCornerRadius = a.getDimension(R.styleable.RoundImageView_riv_rightTop_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.RoundImageView_riv_rightBottom_corner_radius, 0);
